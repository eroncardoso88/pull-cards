...
const CombinationType: NextPage = (props) => {
  const { data: dataCombinationType, isLoading: isLoadingCombinationType } = trpc.useQuery(["combination-type.list-combination-type"])
  ...
  const { mutate, isSuccess, error } = trpc.useMutation(["combination-type.create-combination-type"], {
    onSuccess: (success) => {
